...
root = Tk()
root.title("Salary Predictor by Harshada")
...
def find():
	try:
		data = pd.read_csv("C:/harshada/machinelearning_kamalSir/lec-2/esmsep23.csv")
		feature = data[["exp"]]
		target = data["sal"]
...
btn_predict = Button(root, text = "Predict Salary", font = f, command = find)
